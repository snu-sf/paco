...
print ("*)")
print ()
print ('Tactic Notation "cfinal_" :=')
print ("  match goal with")
for n in range(relsize+1):
    print ("  | [|- context[cpaco"+str(n)+"]] => eapply cpaco"+str(n)+"_final; [eauto with paco|]")
print ("  end.")
print ("Ltac cfinal := repeat red; under_forall ltac:(cfinal_).")
print ()
...
print ("  match goal with")
for n in range(relsize+1):
    print ("  | [|- context[cpaco"+str(n)+"]] => eapply cpaco"+str(n)+"_cupaco; [eauto with paco|]")
print ("  end.")
...
print ("  match goal with")
for n in range(relsize+1):
    print ("  | [|- context[cpaco"+str(n)+"]]  => eapply cpaco"+str(n)+"_uclo; [|eapply H|]; [eauto with paco|..]")
print ("  end.")
...
for n in range(relsize+1):
    ...
    print ("    pcofix CIH using @cpaco"+str(n)+"_cofix with r; [eauto with paco|]")
print ("  end.")
