...
print ("  - econstructor 2; [intros; eapply H, PR| apply CLOR'].")
...
print ('      r clo (RES: respectful'+str(n)+' clo):')
...
print ('  eapply grespectful'+str(n)+'_greatest; [apply RES|apply PR].')
print ('Qed.')
print ('')
...
print ('  clo (gres'+str(n)+' r) <'+str(n)+'= gres'+str(n)+' r.')
print ('Proof.')
print ('  intros. eapply grespectful'+str(n)+'_compose; [apply RES|apply PR].')
print ('Qed.')
print ('')
...
print ("Lemma rclo"+str(n)+"_mon_gen"+itrstr(" T",n)+" (gf gf': "+"rel"+str(n)+itrstr(" T",n)+" -> "+"rel"+str(n)+itrstr(" T",n)+") clo clo' r r'"+itrstr(" e", n))
print ("      (REL: rclo"+str(n)+" gf clo r"+itrstr(" e", n)+")")
print ("      (LEgf: gf <"+str(n+1)+"= gf')")
print ("      (LEclo: clo <"+str(n+1)+"= clo')")
print ("      (LEr: r <"+str(n)+"= r') :")
print ("  rclo"+str(n)+" gf' clo' r'"+itrstr(" e", n)+".")
print ("Proof.")
print ("  induction REL.")
print ("  - econstructor 1. apply LEr, R.")
print ("  - econstructor 2; [intros; eapply H, PR| apply LEclo, CLOR'].")
print ("  - econstructor 3; [intros; eapply H, PR| apply LEgf, CLOR'].")
print ("Qed.")
print ("")
...
print ('Ltac pupto'+str(n)+' H := first [eapply upto'+str(n)+'_step|eapply upto'+str(n)+'_step_under]; [|(eapply H || eapply weak_respectful'+str(n)+'_respectful'+str(n)+', H)|]; [eauto with paco|].')
print ('')
