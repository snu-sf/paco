...
print ("  curry"+str(n)+" (paco (fun R0 => uncurry"+str(n)+" (gf (curry"+str(n)+" R0))) (uncurry"+str(n)+" r)).")
print ("")
...
print ("Qed.")
print ("")
print ("Theorem paco"+str(n)+"_acc r")
print ("      (X: Type)"+itrstr(" x", n)+"")
print ("      (OBG: forall rr (INC: r <"+str(n)+"= rr) (CIH: forall (x: X), rr"+itrstr(" (x", n, " x)")+"),")
print ("            forall (x: X), paco"+str(n)+" gf rr"+itrstr(" (x", n, " x)")+"):")
print ("  forall (x: X), paco"+str(n)+" gf r"+itrstr(" (x", n, " x)")+".")
print ("Proof.")
print ("  eapply paco_acc.")
print ("  intros. apply uncurry_adjoint1_"+str(n)+" in INC.")
print ("  eapply paco_mon.")
print ("  - apply (OBG (curry"+str(n)+" rr) INC CIH x).")
print ("  - intros. destruct x"+str(n)+". assumption.")
print ("Qed.")
print ("")
