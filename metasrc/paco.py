...
print ("Theorem _paco"+str(n)+"_algebra (MON: _monotone"+str(n)+" gf) r :")
print ("  r <"+str(n)+"== gf r -> r <"+str(n)+"== paco"+str(n)+" gf bot"+str(n)+".")
print ("Proof.")
print ("  intros. apply uncurry_adjoint1_"+str(n)+".")
print ("  apply _paco_algebra.")
print ("  apply monotone"+str(n)+"_map; assumption.")
...
print ("Theorem paco"+str(n)+"_algebra r (MON: monotone"+str(n)+" gf) :")
print ("  r <"+str(n)+"= gf r -> r <"+str(n)+"= paco"+str(n)+" gf bot"+str(n)+".")
print ("Proof.")
print ("  repeat_intros 1. eapply _paco"+str(n)+"_algebra. apply monotone"+str(n)+"_eq; assumption.")
print ("  repeat intro. apply x0, PR.")
print ("Qed.")
print ("")
