...
print ('*)')
print ('')
print ('Ltac _punfold H := let x := fresh "_x_" in')
...
print ('Ltac punfold H := _punfold H; eauto with paco.')
print ('')
...
print ('*)')
print ()
print ('Lemma paco_clear_bot: forall P:Prop, P \/ False <-> P.')
print ('Proof. tauto. Qed.')
print ()
print ('Ltac pclearbot :=')
print ('  let X := fresh "_X" in')
print ('  repeat match goal with')
print ('  | [H: context[pacoid] |- _] => try red in H; setoid_rewrite paco_clear_bot in H')
print ('  end.')
print ()
