...
print ("  _punfold H; [..|apply cpaco"+str(n)+"_def_mon]. eapply cpaco"+str(n)+"_def_mon. apply H.")
...
print ("      r rg (LEr: r <"+str(n)+"= rg):")
print ("  cupaco"+str(n)+" (cpaco"+str(n)+" r rg) <"+str(n)+"= cpaco"+str(n)+" r rg.")
print ("Proof.")
print ("  eapply cpaco"+str(n)+"_cofix. apply LEr.")
...
print ("Qed.")
print ("")
print ("Lemma cpaco"+str(n)+"_uclo (uclo: rel -> rel)")
print ("      r rg (LEr: r <"+str(n)+"= rg)")
print ("      (LEclo: uclo <"+str(n+1)+"= cupaco"+str(n)+") :")
print ("  uclo (cpaco"+str(n)+" r rg) <"+str(n)+"= cpaco"+str(n)+" r rg.")
print ("Proof.")
print ("  intros. apply cpaco"+str(n)+"_cupaco. apply LEr. apply LEclo, PR.")
print ("Qed.")
print ("")
