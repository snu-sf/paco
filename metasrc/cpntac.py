...
for n in range(relsize+1):
    print ("  | [|- context[paco"+str(n)+"]] => eapply cpn"+str(n)+"_init; [eauto with paco|eauto with paco|]")
print ("  end.")
...
print ("  match goal with")
for n in range(relsize+1):
    print ("  | [|- context[fcpn"+str(n)+"]] => eapply fcpn"+str(n)+"_final; [eauto with paco|eauto with paco|]")
    print ("  | [|- context[cpn"+str(n)+"]]  => eapply cpn"+str(n)+"_final; [eauto with paco|eauto with paco|]")
print ("  end.")
...
print ("  match G with")
for n in range(relsize+1):
    print ("  | context[cpn"+str(n)+"] => eapply cpn"+str(n)+"_unfold in H; [|eauto with paco|eauto with paco]")
print ("  end.")
print ()
...
print ("*)")
print ()
print ('Ltac uunfoldb H :=')
print ("  repeat red in H;")
print ("  let G := type of H in");
print ("  match G with")
for n in range(relsize+1):
    print ("  | context[cpn"+str(n)+"] => eapply cpn"+str(n)+"_unfold_bound in H; [|eauto with paco|eauto with paco|eauto with paco]")
print ("  end.")
print ()
...
print ("*)")
print ()
print ('Tactic Notation "ubound_" :=')
print ("  match goal with")
for n in range(relsize+1):
    print ("  | [|- context[cpn"+str(n)+"]] => eapply cpn"+str(n)+"_bound; [eauto with paco|]")
print ("  end.")
print ("Ltac ubound := under_forall ltac:(ubound_).")
print ()
...
print ("  match goal with")
for n in range(relsize+1):
    print ("  | [|- context[cpn"+str(n)+"]] => eapply cpn"+str(n)+"_cpn; [eauto with paco|eauto with paco|]")
print ("  end.")
...
print ("  match goal with")
for n in range(relsize+1):
    print ("  | [|- context[cpn"+str(n)+"]] => eapply cpn"+str(n)+"_step; [eauto with paco|eauto with paco|]")
print ("  end.")
...
print ("  match goal with")
for n in range(relsize+1):
    print ("  | [|- context[fcpn"+str(n)+"]] => eapply fcpn"+str(n)+"_clo; [| |eapply H|]; [eauto with paco|eauto with paco|]")
print ("  end.")
print ("Ltac guclo_ H := under_forall ltac:(guclo__ H).")
print ('Tactic Notation "uclo__" constr(H) :=')
print ("  match goal with")
for n in range(relsize+1):
    print ("  | [|- context[cpn"+str(n)+"]]  => eapply cpn"+str(n)+"_clo; [| |eapply H|]; [eauto with paco|eauto with paco|]")
print ("  end.")
...
for n in range(relsize+1):
    ...
    print ("    (eapply fcpn"+str(n)+"_from_paco; [eauto with paco|eauto with paco|]); paco_revert_hyp _paco_mark;")
...
for n in range(relsize+1):
    ...
    print ("    (eapply cpn"+str(n)+"_from_paco; [eauto with paco|eauto with paco|]); paco_revert_hyp _paco_mark;")
    print ("    pcofix CIH with r;")
    print ("    under_forall ltac:(eapply fcpn"+str(n)+"_to_paco; [eauto with paco|])")
print ("  end.")
