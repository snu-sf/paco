...
print ('  clear TP;')
print ('  assert (XP: EP) by (unfold EP; clear -CIH; repeat intro; apply CIH; repeat eexists );')
...
for n in range (1,relsize+1):
    ...
    print ('| [H: _paco_id (@exist'+str(n)+'T _ _ _ _'+itrstr(' ?x', n)+' = @exist'+str(n)+'T _ _ _ _'+itrstr(' ?y', n)+') |- _] =>')
