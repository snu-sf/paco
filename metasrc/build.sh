...
python pcpntac.py $maxsize > $PACOSRCDIR/pcpntac.v
python gcpntac.py $maxsize > $PACOSRCDIR/gcpntac.v

echo "" > $PACOSRCDIR/pacoall.v
echo "" > $PACOSRCDIR/pcpnall.v
...
echo "Require Export pcpnall." >> $PACOSRCDIR/paco.v
echo "Require Export pcpntac." >> $PACOSRCDIR/paco.v
