...
for n in range(relsize+1):
    print ("  | [|- context[cpn"+str(n)+"]] => eapply gcpn"+str(n)+"_init; [eauto with paco|eauto with paco|]")
print ("  end.")
...
print ("  match G with")
for n in range(relsize+1):
    print ("  | context[gcpn"+str(n)+"] => eapply gcpn"+str(n)+"_unfold in H; [|eauto with paco|eauto with paco]")
print ("  end.")
print ()
...
print ("*)")
print ()
print ('Tactic Notation "gbound_" :=')
print ("  match goal with")
for n in range(relsize+1):
    print ("  | [|- context[gcpn"+str(n)+"]] => eapply gcpn"+str(n)+"_bound; [eauto with paco|]")
print ("  end.")
print ("Ltac gbound := repeat red; under_forall ltac:(gbound_).")
print ()
...
print ("  match goal with")
for n in range(relsize+1):
    print ("  | [|- context[gcpn"+str(n)+"]] => eapply gcpn"+str(n)+"_cpn; [eauto with paco|eauto with paco|]")
print ("  end.")
...
print ("  match goal with")
for n in range(relsize+1):
    print ("  | [|- context[gcpn"+str(n)+"]] => eapply gcpn"+str(n)+"_step; [eauto with paco|eauto with paco|]")
print ("  end.")
...
print ("  match goal with")
for n in range(relsize+1):
    print ("  | [|- context[gcpn"+str(n)+"]]  => eapply gcpn"+str(n)+"_clo; [| |eapply H|]; [eauto with paco|eauto with paco|]")
print ("  end.")
...
for n in range(relsize+1):
    ...
    print ("    pcofix CIH using @gcpn"+str(n)+"_cofix with r; [eauto with paco|eauto with paco|eauto with paco; try contradiction|]")
print ("  end.")
