...
print ("Qed.")
print ("")
print ("Lemma wcpn"+str(n)+"_unfold:")
print ("  wcpn"+str(n)+" bot"+str(n)+" bot"+str(n)+" <"+str(n)+"= gf (wcpn"+str(n)+" bot"+str(n)+" bot"+str(n)+").")
print ("Proof.")
print ("  intros. apply wcpn"+str(n)+"_init in PR. uunfold PR.")
print ("  eapply gf_mon; [apply PR|].")
print ("  intros. apply wcpn"+str(n)+"_final. apply PR0.")
print ("Qed.")
print ("")
