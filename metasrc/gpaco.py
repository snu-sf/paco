...
print ("Proof.")
print ("  intros. eapply cpn"+str(n)+"_greatest, PR. apply wcompat"+str(n)+"_compat. apply cpn"+str(n)+"_wcompat.")
print ("Qed.")
print ("")
...
print ("  left. revert"+itrstr(" x", n)+" H.")
print ("  pcofix CIH; intros.")
print ("  apply rclo"+str(n)+"_compat in H0; [|apply gf_mon|apply CMP].")
...
print ("  { eapply rclo"+str(n)+"_mon. apply PR. intros. apply gpaco"+str(n)+"_unfold in PR0. apply PR0. apply gf_mon. }")
print ("  apply rclo"+str(n)+"_rclo in REL.")
print ("  apply rclo"+str(n)+"_dist in REL; [|apply CMP|apply DIST].")
print ("  destruct REL; cycle 1.")
print ("  - right. apply CIH0, H.")
print ("  - right. apply CIH.")
print ("    eapply rclo"+str(n)+"_mon. apply H. intros.")
print ("    eapply gf_mon. apply PR0. intros.")
print ("    eapply gupaco"+str(n)+"_mon. apply PR1. intros.")
print ("    destruct PR2; apply H1.")
print ("Qed.")
print ("")
print ("End Soundness.")
print ("")
