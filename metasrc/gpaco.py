...
print ("  intros. destruct PR0.")
print ("  - apply rclo"+str(n)+"_base. right. apply CIH0. apply H.")
print ("  - destruct H; [destruct H|].")
print ("    + apply rclo"+str(n)+"_base. right. apply CIH. left. apply H.")
print ("    + apply IN in H. destruct H.")
print ("      eapply rclo"+str(n)+"_mon. apply IN0.")
print ("      intros. destruct PR0.")
print ("      * right. apply CIH0. apply H.")
print ("      * right. apply CIH. right. apply H.")
print ("    + apply rclo"+str(n)+"_base. right. apply CIH. right. apply H.")
print ("Qed.")
print ("")
