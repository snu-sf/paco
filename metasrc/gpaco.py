...
print ("  apply paco"+str(n)+"_acc; intros * CIH0 CIH * H0.")
...
print ("  apply paco"+str(n)+"_acc; intros * _ CIH * IN.")
...
print ("    | [ |- _ "+itrstr(" ?y", n)+" ] =>")
print ("      assert (REL: @rclo"+str(n)+" clo (rclo"+str(n)+" clo (gf (gupaco"+str(n)+" gf clo ((rg \\"+str(n)+"/ r) \\"+str(n)+"/ (rg \\"+str(n)+"/ r))) \\"+str(n)+"/ (rg \\"+str(n)+"/ r)))"+itrstr(" y", n)+")")
print ("    end.")
...
print ("    revert"+itrstr(" x", n)+" H. apply paco"+str(n)+"_acc; intros * CIH0 CIH * H0.")
