...
Proof.
  ...
  apply paco12_acc; intros * CIH0 CIH * H0.
...
Proof.
  ...
  apply paco12_acc; intros * _ CIH * IN.
...
Proof.
  ...
  - match goal with
    | [ |- _  ?y0 ?y1 ?y2 ?y3 ?y4 ?y5 ?y6 ?y7 ?y8 ?y9 ?y10 ?y11 ] =>
      assert (REL: @rclo12 clo (rclo12 clo (gf (gupaco12 gf clo ((rg \12/ r) \12/ (rg \12/ r))) \12/ (rg \12/ r))) y0 y1 y2 y3 y4 y5 y6 y7 y8 y9 y10 y11)
    end.
...
Proof.
  ...
  - econstructor. apply rclo12_base. left.
    revert x0 x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 H. apply paco12_acc; intros * CIH0 CIH * H0.
...
Hint Resolve prespect12_uclo : paco.
