...
Context `{T7 : forall (x0: @T0) (x1: @T1 x0) (x2: @T2 x0 x1) (x3: @T3 x0 x1 x2) (x4: @T4 x0 x1 x2 x3) (x5: @T5 x0 x1 x2 x3 x4) (x6: @T6 x0 x1 x2 x3 x4 x5), Type}.

Local Open Scope paco_scope.
Local Notation rel := (rel8 T0 T1 T2 T3 T4 T5 T6 T7).
Local Notation "r <= r'" := (r <8= r') : paco_scope.
Local Notation "r <1= r'" := (r <9= r') : paco_scope.
Local Notation "r \/ r'" := (r \8/ r') : paco_scope.
Local Notation "r \1/ r'" := (r \9/ r') : paco_scope.

(** ** Predicates of Arity 8 *)

Let t : arityn 8 := Eval compute in (
    aritynS (@T0) (fun x0 =>
...
Inductive paco8 (gf : rel -> rel) (r : rel)  x0 x1 x2 x3 x4 x5 x6 x7 : Prop :=
  internal_mk_paco (_ : _paco gf r x0 x1 x2 x3 x4 x5 x6 x7).

Definition upaco8 (gf : rel -> rel) (r : rel) : rel := paco8 gf r \/ r.
Arguments paco8 : clear implicits.
Arguments upaco8 : clear implicits.
Hint Unfold upaco8 : core.

Local Notation bot := bot8.
Local Notation paco := paco8.
Local Notation upaco := upaco8.
...
Definition inst (gf : rel->_) r x0 x1 x2 x3 x4 x5 x6 x7 : paco_class (paco gf r x0 x1 x2 x3 x4 x5 x6 x7) := {|
...
Notation paco8 := paco8.paco8.
Notation upaco8 := paco8.upaco8.
Notation monotone8 := paco8.monotone.
