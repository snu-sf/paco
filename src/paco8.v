...
Theorem paco8_acc r
      (X: Type) x0 x1 x2 x3 x4 x5 x6 x7
      (OBG: forall rr (INC: r <8= rr) (CIH: forall (x: X), rr (x0 x) (x1 x) (x2 x) (x3 x) (x4 x) (x5 x) (x6 x) (x7 x)),
            forall (x: X), paco8 gf rr (x0 x) (x1 x) (x2 x) (x3 x) (x4 x) (x5 x) (x6 x) (x7 x)):
  forall (x: X), paco8 gf r (x0 x) (x1 x) (x2 x) (x3 x) (x4 x) (x5 x) (x6 x) (x7 x).
Proof.
  eapply paco_acc.
  intros. apply uncurry_adjoint1_8 in INC.
  eapply paco_mon.
  - apply (OBG (curry8 rr) INC CIH x).
  - intros. destruct x8. assumption.
Qed.
