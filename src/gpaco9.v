...
Proof.
  ...
  apply paco9_acc; intros * CIH0 CIH * H0.
...
Proof.
  ...
  apply paco9_acc; intros * _ CIH * IN.
...
Proof.
  ...
  - match goal with
    | [ |- _  ?y0 ?y1 ?y2 ?y3 ?y4 ?y5 ?y6 ?y7 ?y8 ] =>
      assert (REL: @rclo9 clo (rclo9 clo (gf (gupaco9 gf clo ((rg \9/ r) \9/ (rg \9/ r))) \9/ (rg \9/ r))) y0 y1 y2 y3 y4 y5 y6 y7 y8)
    end.
...
Proof.
  ...
  - econstructor. apply rclo9_base. left.
    revert x0 x1 x2 x3 x4 x5 x6 x7 x8 H. apply paco9_acc; intros * CIH0 CIH * H0.
