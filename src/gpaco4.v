...
Proof.
  ...
  apply paco4_acc; intros * CIH0 CIH * H0.
...
Proof.
  ...
  apply paco4_acc; intros * _ CIH * IN.
...
Proof.
  ...
  - match goal with
    | [ |- _  ?y0 ?y1 ?y2 ?y3 ] =>
      assert (REL: @rclo4 clo (rclo4 clo (gf (gupaco4 gf clo ((rg \4/ r) \4/ (rg \4/ r))) \4/ (rg \4/ r))) y0 y1 y2 y3)
    end.
...
Proof.
  ...
  - econstructor. apply rclo4_base. left.
    revert x0 x1 x2 x3 H. apply paco4_acc; intros * CIH0 CIH * H0.
