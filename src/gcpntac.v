...
Tactic Notation "ginit_" :=
  ...
  | [|- context[cpn15]] => eapply gcpn15_init; [eauto with paco|]
  end.
...
Ltac gunfold H :=
  ...
  | context[gcpn15] => eapply gcpn15_unfold in H; [|eauto with paco]
  end.
...
Tactic Notation "gcpn_" :=
  ...
  | [|- context[gcpn15]] => eapply gcpn15_cpn; [eauto with paco|]
  end.
...
Tactic Notation "gstep_" :=
  ...
  | [|- context[gcpn15]] => eapply gcpn15_step; [eauto with paco|]
  end.
...
Tactic Notation "gcofix" ident(CIH) "with" ident(r) :=
  ...
  | [|- context[gcpn15]]  =>
    paco_revert_hyp _paco_mark;
    pcofix CIH using @gcpn15_cofix with r; [eauto with paco|eauto with paco; try contradiction|]
  end.
