...
Proof. unfold le0. repeat_intros 0; auto. Qed.
...
Proof.
  apply uncurry_map_rev0. eapply le1_trans; [eauto|]. apply curry_bij2_0.
Qed.

Lemma uncurry_adjoint2_0 r0 r1 (LE: r0 <0== curry0 r1) : uncurry0 r0 <1== r1.
Proof.
  apply curry_map_rev0. eapply le0_trans; [|eauto]. apply uncurry_bij2_0.
Qed.
...
Proof.
  apply uncurry_map_rev0. eapply le1_trans; [|eauto]. apply curry_bij1_0.
Qed.
...
Proof. unfold monotone0, _monotone0, le0. split; eauto. Qed.

Lemma monotone0_map (gf: rel0 -> rel0)
      (MON: _monotone0 gf) :
  _monotone (fun R0 => uncurry0 (gf (curry0 R0))).
Proof.
  repeat_intros 3. apply uncurry_map0. apply MON; apply curry_map0; auto.
Qed.
...
Proof.
  repeat_intros 3. eapply curry_map0, _paco_mon; apply uncurry_map0; auto.
Qed.
...
Proof.
  ...
  eapply _paco_unfold; apply monotone0_map; auto.
Qed.
...
Theorem paco0_unfold: forall (MON: monotone0 gf) r,
  paco0 gf r <0= gf (upaco0 gf r).
Proof.
  repeat_intros 1. eapply _paco0_unfold; apply monotone0_eq; auto.
Qed.
...
Proof. unfold monotone0_2, _monotone0_2, le0. split; eauto. Qed.

Lemma monotone0_2_map (gf: rel0 -> rel0 -> rel0)
      (MON: _monotone0_2 gf) :
  _monotone_2 (fun R0 R1 => uncurry0 (gf (curry0 R0) (curry0 R1))).
Proof.
  repeat_intros 6. apply uncurry_map0. apply MON; apply curry_map0; auto.
Qed.
...
Proof.
  repeat_intros 6. eapply curry_map0, _paco_2_0_mon; apply uncurry_map0; auto.
Qed.

Theorem _paco0_2_1_mon: _monotone0_2 (paco0_2_1 gf_0 gf_1).
Proof.
  repeat_intros 6. eapply curry_map0, _paco_2_1_mon; apply uncurry_map0; auto.
Qed.
...
Proof.
  intros. apply curry_adjoint2_0.
  eapply _paco_2_0_unfold; apply monotone0_2_map; auto.
Qed.
...
Proof.
  intros. apply curry_adjoint2_0.
  eapply _paco_2_1_unfold; apply monotone0_2_map; auto.
Qed.
...
Theorem paco0_2_0_unfold: forall (MON: monotone0_2 gf_0) (MON: monotone0_2 gf_1) r_0 r_1,
  paco0_2_0 gf_0 gf_1 r_0 r_1 <0= gf_0 (upaco0_2_0 gf_0 gf_1 r_0 r_1) (upaco0_2_1 gf_0 gf_1 r_0 r_1).
Proof.
  repeat_intros 2. eapply _paco0_2_0_unfold; apply monotone0_2_eq; auto.
Qed.

Theorem paco0_2_1_unfold: forall (MON: monotone0_2 gf_0) (MON: monotone0_2 gf_1) r_0 r_1,
  paco0_2_1 gf_0 gf_1 r_0 r_1 <0= gf_1 (upaco0_2_0 gf_0 gf_1 r_0 r_1) (upaco0_2_1 gf_0 gf_1 r_0 r_1).
Proof.
  repeat_intros 2. eapply _paco0_2_1_unfold; apply monotone0_2_eq; auto.
Qed.
...
Proof. unfold monotone0_3, _monotone0_3, le0. split; eauto. Qed.

Lemma monotone0_3_map (gf: rel0 -> rel0 -> rel0 -> rel0)
      (MON: _monotone0_3 gf) :
  _monotone_3 (fun R0 R1 R2 => uncurry0 (gf (curry0 R0) (curry0 R1) (curry0 R2))).
Proof.
  repeat_intros 9. apply uncurry_map0. apply MON; apply curry_map0; auto.
Qed.
...
Proof.
  intros. apply curry_adjoint2_0.
  eapply _paco_3_0_unfold; apply monotone0_3_map; auto.
Qed.
...
Proof.
  intros. apply curry_adjoint2_0.
  eapply _paco_3_1_unfold; apply monotone0_3_map; auto.
Qed.
...
Proof.
  intros. apply curry_adjoint2_0.
  eapply _paco_3_2_unfold; apply monotone0_3_map; auto.
Qed.
