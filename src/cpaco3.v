...
Proof.
  eapply compose_monotone3. apply gf_mon. apply rclo3_mon.
Qed.
...
Proof.
  ...
  apply compat3_compat. apply rclo3_compat. apply gf_mon. apply clo_compat.
  eapply rclo3_mon. apply IN.
  intros. destruct PR. contradiction.
  punfold H. eapply cpaco3_def_mon. apply H.
...
Proof.
  intros. apply cpaco3_init in PR. punfold PR.
...
Proof.
  ...
  destruct IN. econstructor.
  eapply rclo3_mon_gen, IN. apply LEclo.
  intros. destruct PR. left; apply H.
  right. eapply paco3_mon_gen. apply H.
  - intros. eapply LEgf.
    eapply MON. apply PR.
    eapply rclo3_mon_gen. apply LEclo. intros; apply PR0.
  - intros. apply PR.
Qed.
