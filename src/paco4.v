...
Theorem upaco4_2_0_mon: monotone4_2 (upaco4_2_0 gf_0 gf_1).
Proof.
  repeat_intros 8. intros R  LE0 LE1.
  destruct R.
  - left. eapply paco4_2_0_mon. apply H. apply LE0. apply LE1.
  - right. apply LE0, H.
Qed.
Theorem upaco4_2_1_mon: monotone4_2 (upaco4_2_1 gf_0 gf_1).
Proof.
  repeat_intros 8. intros R  LE0 LE1.
  destruct R.
  - left. eapply paco4_2_1_mon. apply H. apply LE0. apply LE1.
  - right. apply LE1, H.
Qed.
...
Arguments upaco4_2_0_mon : clear implicits.
Arguments upaco4_2_1_mon : clear implicits.
...
Theorem upaco4_3_0_mon: monotone4_3 (upaco4_3_0 gf_0 gf_1 gf_2).
Proof.
  repeat_intros 10. intros R  LE0 LE1 LE2.
  destruct R.
  - left. eapply paco4_3_0_mon. apply H. apply LE0. apply LE1. apply LE2.
  - right. apply LE0, H.
Qed.
Theorem upaco4_3_1_mon: monotone4_3 (upaco4_3_1 gf_0 gf_1 gf_2).
Proof.
  repeat_intros 10. intros R  LE0 LE1 LE2.
  destruct R.
  - left. eapply paco4_3_1_mon. apply H. apply LE0. apply LE1. apply LE2.
  - right. apply LE1, H.
Qed.
Theorem upaco4_3_2_mon: monotone4_3 (upaco4_3_2 gf_0 gf_1 gf_2).
Proof.
  repeat_intros 10. intros R  LE0 LE1 LE2.
  destruct R.
  - left. eapply paco4_3_2_mon. apply H. apply LE0. apply LE1. apply LE2.
  - right. apply LE2, H.
Qed.
...
Arguments upaco4_3_0_mon : clear implicits.
Arguments upaco4_3_1_mon : clear implicits.
Arguments upaco4_3_2_mon : clear implicits.
...
Lemma upaco4_clear gf x0 x1 x2 x3:
  upaco4 gf bot4 x0 x1 x2 x3 <-> paco4 gf bot4 x0 x1 x2 x3.
