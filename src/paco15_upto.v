...
Definition cgres15 := compose gf gres15.

Lemma upto15_init:
  paco15 cgres15 bot15 <15= paco15 gf bot15.
Proof.
  apply sound15_is_gf.
...
Lemma upto15_step
  ...
  clo (paco15 cgres15 r) <15= paco15 cgres15 r.
Proof.
...
Lemma rclo15_mon_gen T0 T1 T2 T3 T4 T5 T6 T7 T8 T9 T10 T11 T12 T13 T14 (gf gf': rel15 T0 T1 T2 T3 T4 T5 T6 T7 T8 T9 T10 T11 T12 T13 T14 -> rel15 T0 T1 T2 T3 T4 T5 T6 T7 T8 T9 T10 T11 T12 T13 T14) clo clo' r r' e0 e1 e2 e3 e4 e5 e6 e7 e8 e9 e10 e11 e12 e13 e14
      (REL: rclo15 gf clo r e0 e1 e2 e3 e4 e5 e6 e7 e8 e9 e10 e11 e12 e13 e14)
      (LEgf: gf <16= gf')
      (LEclo: clo <16= clo')
      (LEr: r <15= r') :
  rclo15 gf' clo' r' e0 e1 e2 e3 e4 e5 e6 e7 e8 e9 e10 e11 e12 e13 e14.
Proof.
  induction REL.
...
Proof.
  ...
  - eapply grespectful15_impl; [apply H | split; apply EQ].
Qed.
...
Ltac pfold15_reverse_ :=
  repeat red;
  match goal with
  | [|- ?gf (upaco15 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _) _ _ _ _ _ _ _ _ _ _ _ _ _ _ _] => eapply (paco15_unfold (gf := gf))
  | [|- ?gf (?gres (upaco15 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _)) _ _ _ _ _ _ _ _ _ _ _ _ _ _ _] => eapply (paco15_unfold (gf := cgres15 gf))
  end.
...
Ltac punfold15_reverse_ H :=
  ...
  | ?gf (?gres (upaco15 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _)) _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ => eapply (paco15_fold (cgres15 gf)) in H
  end.
