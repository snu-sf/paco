...
Lemma upto11_step_under
  ...
  clo (gres11 r) <11= gres11 r.
Proof.
  intros. eapply grespectful11_compose; [apply RES|apply PR].
Qed.

End Respectful11.

Lemma rclo11_mon_gen T0 T1 T2 T3 T4 T5 T6 T7 T8 T9 T10 (gf gf': rel11 T0 T1 T2 T3 T4 T5 T6 T7 T8 T9 T10 -> rel11 T0 T1 T2 T3 T4 T5 T6 T7 T8 T9 T10) clo clo' r r' e0 e1 e2 e3 e4 e5 e6 e7 e8 e9 e10
      (REL: rclo11 gf clo r e0 e1 e2 e3 e4 e5 e6 e7 e8 e9 e10)
      (LEgf: gf <12= gf')
      (LEclo: clo <12= clo')
      (LEr: r <11= r') :
  rclo11 gf' clo' r' e0 e1 e2 e3 e4 e5 e6 e7 e8 e9 e10.
Proof.
  induction REL.
...
Proof.
  ...
  - eapply grespectful11_impl; [apply H | split; apply EQ].
Qed.
...
Ltac pupto11 H := first [eapply upto11_step|eapply upto11_step_under]; [|(eapply H || eapply weak_respectful11_respectful11, H)|]; [eauto with paco|].
