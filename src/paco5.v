...
Theorem paco5_acc r
      (X: Type) x0 x1 x2 x3 x4
      (OBG: forall rr (INC: r <5= rr) (CIH: forall (x: X), rr (x0 x) (x1 x) (x2 x) (x3 x) (x4 x)),
            forall (x: X), paco5 gf rr (x0 x) (x1 x) (x2 x) (x3 x) (x4 x)):
  forall (x: X), paco5 gf r (x0 x) (x1 x) (x2 x) (x3 x) (x4 x).
Proof.
  eapply paco_acc.
  intros. apply uncurry_adjoint1_5 in INC.
  eapply paco_mon.
  - apply (OBG (curry5 rr) INC CIH x).
  - intros. destruct x5. assumption.
Qed.
