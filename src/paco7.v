...
Theorem paco7_acc r
      (X: Type) x0 x1 x2 x3 x4 x5 x6
      (OBG: forall rr (INC: r <7= rr) (CIH: forall (x: X), rr (x0 x) (x1 x) (x2 x) (x3 x) (x4 x) (x5 x) (x6 x)),
            forall (x: X), paco7 gf rr (x0 x) (x1 x) (x2 x) (x3 x) (x4 x) (x5 x) (x6 x)):
  forall (x: X), paco7 gf r (x0 x) (x1 x) (x2 x) (x3 x) (x4 x) (x5 x) (x6 x).
Proof.
  eapply paco_acc.
  intros. apply uncurry_adjoint1_7 in INC.
  eapply paco_mon.
  - apply (OBG (curry7 rr) INC CIH x).
  - intros. destruct x7. assumption.
Qed.
