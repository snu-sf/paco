...
Proof.
  ...
  _punfold H; [..|apply cpaco1_def_mon]. eapply cpaco1_def_mon. apply H.
...
Lemma cpaco1_uclo (uclo: rel -> rel)
      r rg (LEr: r <1= rg)
      (LEclo: uclo <2= cupaco1) :
  uclo (cpaco1 r rg) <1= cpaco1 r rg.
Proof.
  intros. apply cpaco1_cupaco. apply LEr. apply LEclo, PR.
Qed.
