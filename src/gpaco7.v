...
Proof.
  ...
  intros. destruct PR0.
  - apply rclo7_base. right. apply CIH0. apply H.
  - destruct H; [destruct H|].
    + apply rclo7_base. right. apply CIH. left. apply H.
    + apply IN in H. destruct H.
      eapply rclo7_mon. apply IN0.
      intros. destruct PR0.
      * right. apply CIH0. apply H.
      * right. apply CIH. right. apply H.
    + apply rclo7_base. right. apply CIH. right. apply H.
Qed.
...
Proof.
  ...
  pstep. eapply gf_mon; [apply H0|]. clear x0 x1 x2 x3 x4 x5 x6 H0. intros.
  ...
  - assert (REL: @rclo7 clo (rclo7 clo (gf (gupaco7 gf clo ((rg \7/ r) \7/ (rg \7/ r))) \7/ (rg \7/ r))) x0 x1 x2 x3 x4 x5 x6).
    ...
    + apply CIH, H0.
    + apply CIH0.
      eapply rclo7_mon. apply H0. intros.
      eapply gf_mon. apply PR. intros.
      eapply gupaco7_mon. apply PR0. intros.
