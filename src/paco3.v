...
Local Notation "r <= r'" := (r <3= r') : paco_scope.
Local Notation "r <1= r'" := (r <4= r') : paco_scope.
Local Notation "r \/ r'" := (r \3/ r') : paco_scope.
Local Notation "r \1/ r'" := (r \4/ r') : paco_scope.

(** ** Predicates of Arity 3 *)

Let t : arityn 3 := Eval compute in (
    aritynS (@T0) (fun x0 =>
...
Definition upaco3 (gf : rel -> rel) (r : rel) : rel := paco3 gf r \/ r.
